...
TEMP_TABLE1="${TEMP_TABLE}_stores_with_regression"
TEMP_TABLE2="${TEMP_TABLE}_reviews_for_stores"
...
query_run_clean_method () {
	runCmdWithErrorCheck runEngineCmd -e "DROP TABLE IF EXISTS $TEMP_TABLE; DROP TABLE IF EXISTS $TEMP_TABLE1; DROP TABLE IF EXISTS $TEMP_TABLE2; DROP TABLE IF EXISTS $RESULT_TABLE;"
	return $?
}
