...
-- Resources
ADD FILE ${QUERY_DIR}/q4_abandonedShoppingCarts.py;
ADD FILE ${QUERY_DIR}/q4_sessionize.py;
...
(
  ...
  REDUCE
    ...
    tstamp_inSec,
    wp_type
  USING 'python3 q4_sessionize.py ${q04_session_timeout_inSec}'
  AS (
    wp_type STRING,
...
(
  ...
  REDUCE 
    ...
    USING 'python3 q4_abandonedShoppingCarts.py'
    AS (pagecount BIGINT)
